 ...
 */
final class Version20200520102941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD country VARCHAR(100) NOT NULL, CHANGE season_id year INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program DROP country, CHANGE year season_id INT NOT NULL');
    }
}
